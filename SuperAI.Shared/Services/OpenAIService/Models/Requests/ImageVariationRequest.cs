...
namespace OpenAI.Net.Models.Requests
{
    public class ImageVariationRequest
    {
        ...
        /// <see href="https://platform.openai.com/docs/api-reference/images/create-variation#images/create-variation-image" />
        /// </summary>
        [Required]
        ...
        /// Defaults to 1 <br/>
        /// <see href="https://platform.openai.com/docs/api-reference/images/create-variation#images/create-variation-n" />
        /// </summary>
        public int? N { get; set; }

        /// <summary>
        /// The size of the generated images. Must be one of 256x256, 512x512, or 1024x1024. <br/>
        /// <see href="https://platform.openai.com/docs/api-reference/images/create-variation#images/create-variation-size" />
        /// </summary>
        ...
        /// Defaults to url <br/>
        /// <see href="https://platform.openai.com/docs/api-reference/images/create-variation#images/create-variation-response_format" />
        /// </summary>
        ...
        /// <see href="https://platform.openai.com/docs/api-reference/images/create-variation#images/create-variation-user" />
        /// </summary>
